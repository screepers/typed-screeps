...
interface Market {
     ...
     * - ERR_INVALID_ARGS: The arguments provided are invalid.
     */
    createOrder(params: CreateOrderParam): OK | ERR_NOT_OWNER | ERR_NOT_ENOUGH_RESOURCES | ERR_FULL | ERR_INVALID_ARGS;
    /**
...
interface PowerCreep extends RoomObject {
    ...
    usePower(
        power: PowerConstant,
        target?: RoomObject,
    ): OK | ERR_NOT_OWNER | ERR_BUSY | ERR_NOT_ENOUGH_RESOURCES | ERR_INVALID_TARGET | ERR_FULL | ERR_NOT_IN_RANGE | ERR_INVALID_ARGS | ERR_TIRED | ERR_NO_BODYPART;
    /**
